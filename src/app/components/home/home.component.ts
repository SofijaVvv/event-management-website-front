...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  selectedYear: Details = {
    id: this.date.getFullYear(),
    name: this.date.getFullYear().toString(),
  };
  monthNames: Details[] = [];
  ...
  ngOnInit() {
    ...
    this.monthNames =
      this.apiCalls.translateMonths[this.translate.currentLang || 'en'];
    this.selectedMonth = this.monthNames[this.selectedMonth.id - 1];
